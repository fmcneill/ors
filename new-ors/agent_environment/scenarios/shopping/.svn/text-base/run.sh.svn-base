...
xterm -bg "#52657F" -fg "#FFFFFF" -geometry "40x12+300+400" -e sicstus --noinfo -l $ORS_HOME/agent_environment/scenarios/shopping/SPA/joinGroupAgentTwo/Agent.pl &
...
xterm -bg "#52657F" -fg "#FFFFFF" -geometry "40x12+20+600" -e sicstus --noinfo -l $ORS_HOME/agent_environment/ExpA/expServerAgent.pl &

sleep 1

xterm -bg lightblue -geometry "85x27+580+200" -e sicstus --noinfo --nologo -l $ORS_HOME/agent_environment/PA/planningAgent.pl  --goal "assert(scenario_name(shopping)),assert(goal(has(shoppingAgent,ourMutualFriend))),assert(ontoType(onto)),assert(experience_sharing(off))." &
