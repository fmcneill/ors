rule(sendContaminant(Agent1,Agent2,Contaminant),
     [rule2,
      [class(60,percentage),class(Contaminant,contaminant),class(Agent2,agent),class(Contaminant,contaminant),class(Agent1,agent),at(Agent1,Contaminant),treats(Agent2,Contaminant,60)],
...
predicate(treats(agent,contaminant,percentage)).
