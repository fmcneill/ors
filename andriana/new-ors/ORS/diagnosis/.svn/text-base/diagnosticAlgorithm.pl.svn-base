...
diagnoseFailure(Me,OntType,Scenario,Action,Agent,[_|_],_,[RelevantSurprisingQuestion|_],Outcome,precondition_anti_abstraction) :-
...
interpretReply_noQuestions(_,Action,Agent,no,_,OntType,Scenario,Outcome,incorrect_agent) :-
...
interpretProblemPreconds(Me,Agent,Just,_,ProblemPrecond,OntType,Scenario,Outcome,problem_precondition) :-
...
attemptRefine(Scenario,RefineType,OntType,RefineInfo,success) :-
	...
	% if is not known if the repair will be performed
...
propositionalRepair(Scenario,Me,Agent,RSQ,ExPrecond,ArityRSQ,ArityExP,NameRSQ,OntType,Outcome,propositional_anti_abstraction) :-
...
propositionalRepair(Scenario,Me,Agent,RSQ,ExPrecond,ArityRSQ,ArityExP,NameRSQ,OntType,Outcome,propositional_abstraction) :-
	-1 is ArityRSQ - ArityExP,
...
domainRepair(Me,Action,Agent,_,class(Object,RightClass),class(Object,WrongClass),OntType,Scenario,Outcome,precondition_anti_abstraction) :-
...
checkSwitchList(Me,Agent,_,_,ExPrecond,Just,[],OntType,Scenario,Outcome,incorrect_instantiation) :-
...
checkSwitchList(_,_,_,_,ExPrecond,_,SwitchList,OntType,Scenario,Outcome,switched_arguments) :-
...
compareDiffs(Me,Agent,_,RSQ,_,ExPArgsClassList,_,MyDiff,HisDiff,OntType,Scenario,Outcome,domain_abstraction) :-
...
compareDiffs(Me,Agent,_,RSQ,_,ExPArgsClassList,_,MyDiff,HisDiff,OntType,Scenario,Outcome,domain_anti_abstraction) :-
...
compareDiffs(Me,Agent,_,_,ExPrecond,_,Just,MyDiff,HisDiff,OntType,Scenario,Outcome,change_of_type) :-
...
checkPredicateSubTypes(Me,Agent,Action,RSQ,[_|RestPreconds],_NameRSQ,NameFP,OntType,Scenario,Outcome,Repair) :-
	NameFP = class,!,
