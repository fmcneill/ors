...
refineMeta(Scenario,Type,Info) :-
	find_ontology_path(Scenario,ScenarioPath),
	atom_concat(ScenarioPath,'/metaOnt.in',OntIn),
	atom_concat(ScenarioPath,'/metaOnt.out',OntOut),
	see(OntIn),tell(OntOut),
	performMetaRef(Type,Info),
	told,seen,
	copyMetaFiles(Scenario).


addPredClass(Scenario,PredClass,PredSuperClass) :-
	find_ontology_path(Scenario,ScenarioPath),
	atom_concat(ScenarioPath,'/metaOnt.in',OntIn),
	atom_concat(ScenarioPath,'/metaOnt.out',OntOut),
	see(OntIn),tell(OntOut),
