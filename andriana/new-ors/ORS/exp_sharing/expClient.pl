...
examineAction(Action,Just,CorrectAgent,QueryList,SurprisingQuestions,Refinements,on) :-
...
examineAction(_Action,_Just,_CorrectAgent,_QueryList,_SurprisingQuestions,[],on) :-
...
consumeRefinement(Agent,Action,ProblemPrecond,shapiro,_,Just,Outcome) :-
	...
	shapiroCheck(pa,Agent,ProblemPrecond,Just,Outcome),!.
