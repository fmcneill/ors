rule(sendWater(Agent1,Agent2,Contaminant,Contaminant2),
     [rule1,
      [class(Contaminant2,contaminant),class(Contaminant,contaminant),class(Agent2,agent),class(Contaminant,contaminant),class(Agent1,agent),at(Agent1,Contaminant),treats(Agent2,Contaminant,Contaminant2)],
...
predicate(treats(agent,contaminant,contaminant)).
