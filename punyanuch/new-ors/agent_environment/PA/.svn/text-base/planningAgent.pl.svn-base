...
performAction(Task,ActionSPA,Outcome) :-
	...
	waitForAnswer(ActionSPA,Task,Outcome).
...
waitForAnswer(ActionSPA,_Action,Outcome) :-
	proxyIn(reply(ActionSPA,pa,_Action,Outcome)).

waitForAnswer(ActionSPA,Action,Outcome) :-
	proxyIn(query(ActionSPA,pa,Type,Ques)),
	write(ActionSPA),write(' asked me '),write(Ques),nl,
	find_best_answer(Type,Ques,Answer,ActionSPA,Action),
...
waitForAnswer(ActionSPA,_Action,_Outcome) :-
	write(ActionSPA),write(' wont bloody talk to me '),nl.



find_best_answer(Type,Ques,BestAnswer,ActionSPA,Action) :-
	solve(Type,Ques,Answer,ActionSPA),
	analyse_answer(Ques,Answer,BestAnswer,ActionSPA,Action).

analyse_answer(Ques,no,BestAnswer,ActionSPA,Action) :-
	checkBridge(Ques,BestAnswer,ActionSPA,Action).

analyse_answer(_Ques,Answer,Answer,_ActionSPA,_Action).
