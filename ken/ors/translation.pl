...
translation(Goal) :-
	consult('translation/translateToPDDL'),
	consult('translation/translateToProlog'),
	consult('translation/translateGoal'),
	consult('translation/translateMetaOnt'),
	see('ont.in'),
...
%	translateToPDDL(TransGoal,IndivList,ProbClassList,DomClassList,NoSitFactList,NoSitPredicateList,NoSitRuleList,NoSitNumericalPredicateList,ClassHierarchyList),
	translateToProlog(ProbClassList,NoSitFactList,NoSitRuleList,NoSitNumericalPredicateList,ClassHierarchyList,NoSitPredicateList),
